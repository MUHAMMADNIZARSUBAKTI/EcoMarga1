    ...
    <div style={{ padding: '2rem 0', minHeight: '80vh' }}>
      <div className="container">
        ...
        <div style={{ 
          ...
          <div className="card" style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'var(--primary-color)' }}>
              Rp {submissions.reduce((sum, item) => sum + item.transfer_amount, 0).toLocaleString()}
            </div>
            <div style={{ color: 'var(--text-light)', fontSize: '0.875rem' }}>
              Total Diterima
            </div>
        ...
        <div className="card">
          ...
          {submissions.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '3rem 0', color: 'var(--text-light)' }}>
              ...
              <a href="/submit" className="btn btn-primary" style={{ marginTop: '1rem' }}>
        ...
        {submissions.length > 0 && (
          <div style={{ 
            ...
            <div style={{ 
              ...
              <span>Menampilkan {submissions.length} dari {submissions.length} transaksi</span>
            </div>
          </div>
        )}
      </div>
